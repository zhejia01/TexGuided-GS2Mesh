...
do
    ...
    # CUDA_VISIBLE_DEVICES=6 python eval_nvs.py --eval \
    #     -m /media/data8T/puhua/SyntheticlightOurs206new/${i}/neilf \
    #     -c /media/data8T/puhua/SyntheticlightOurs206new/${i}/neilf/chkpnt30000.pth \
    #     -t neilf --skip_test

    CUDA_VISIBLE_DEVICES=6 python eval_relighting_syn4.py  \
       -m /media/data8T/puhua/SyntheticlightOurs206new/${i}/neilf   \
       -c /media/data8T/puhua/SyntheticlightOurs206new/${i}/neilf/chkpnt30000.pth  --sample_num 384
done